...
function useDualCalendar(props, type = 'datetime') {
    ...
    const startDateArrayRef = (0, vue_1.computed)(() => {
        return (0, utils_1.dateArray)(startCalendarDateTimeRef.value, props.value, nowRef.value, localeRef.value.firstDayOfWeek);
    });
    const endDateArrayRef = (0, vue_1.computed)(() => {
        return (0, utils_1.dateArray)(endCalendarDateTimeRef.value, props.value, nowRef.value, localeRef.value.firstDayOfWeek);
    });
