...
const self = (vars) => {
    ...
    return Object.assign(Object.assign({}, _common_1.default), { panelColor: popoverColor, panelBoxShadow: boxShadow2, panelDividerColor: dividerColor, itemTextColor: textColor2, itemTextColorActive: primaryColor, itemColorHover: hoverColor, itemOpacityDisabled: opacityDisabled, borderRadius,
        iconColor,
        iconColorDisabled });
};
exports.self = self;
