        ...
        const createSubmenuChildren = () => {
            return ((0, vue_1.h)(_internal_1.NFadeInExpandTransition, null, {
                default: () => {
                    ...
                    return !collapsed ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-submenu-children`, role: "menu" }, tmNodes.map((item) => (0, utils_1.itemRenderer)(item)))) : null;
                }
            }));
        };
        return this.root ? ((0, vue_1.h)(dropdown_1.NDropdown, { builtinThemeOverrides: {
                fontSizeLarge: '14px',
