...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const dataTreeMateRef = props.internalDataTreeMate
            ...
            : displayTreeMateRef;
        const uncontrolledCheckedKeysRef = (0, vue_1.ref)(props.defaultCheckedKeys || props.checkedKeys);
        ...
        const loadingKeysRef = (0, vue_1.ref)([]);
        let dragStartX = 0;
        ...
        (0, vue_1.watch)((0, vue_1.toRef)(props, 'pattern'), (value) => {
            if (value) {
                const { expandedKeys: expandedKeysAfterChange, highlightKeySet } = (0, utils_1.keysWithFilter)(props.data, props.pattern, props.keyField, mergedFilterRef.value);
        ...
        (0, vue_1.watch)(mergedExpandedKeysRef, (value, prevValue) => {
            if (!props.animated) {
        ...
        function doUpdateCheckedKeys(value) {
            ...
            if (onUpdateCheckedKeys)
                (0, _utils_1.call)(onUpdateCheckedKeys, value);
        ...
        function doUpdateSelectedKeys(value) {
            ...
            if (onUpdateSelectedKeys)
                (0, _utils_1.call)(onUpdateSelectedKeys, value);
            if (_onUpdateSelectedKeys)
                (0, _utils_1.call)(_onUpdateSelectedKeys, value);
        }
        // Drag & Drop
    ...
    render() {
        ...
        if (internalScrollable) {
            return ((0, vue_1.h)(scrollbar_1.NxScrollbar, { class: treeClass, tabindex: tabindex, onKeyup: mergedFocusable ? handleKeyup : undefined, onKeydown: mergedFocusable ? handleKeydown : undefined, onFocusout: mergedFocusable ? handleFocusout : undefined, style: this.cssVars, contentStyle: { padding: this.internalScrollablePadding } }, {
