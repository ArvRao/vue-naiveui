...
function useTableData(props, { dataRelatedColsRef }) {
    ...
    const uncontrolledSortStateRef = (0, vue_1.ref)(null);
    ...
    const sortedDataRef = (0, vue_1.computed)(() => {
        ...
        if (activeSorter) {
            ...
            const sorter = activeSorter.sorter === undefined || activeSorter.sorter === 'default'
                ...
                : activeSorter.sorter;
            return filteredData.sort((tmNode1, tmNode2) => (0, utils_1.getFlagOfOrder)(order) * sorter(tmNode1.rawNode, tmNode2.rawNode));
        }
        return filteredDataRef.value;
    });
