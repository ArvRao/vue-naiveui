...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const { rowsRef, colsRef, dataRelatedColsRef, hasEllpisisRef } = (0, use_group_header_1.useGroupHeader)(props);
        const { treeMateRef, mergedCurrentPageRef, paginatedDataRef, rawPaginatedDataRef, selectionColumnRef, hoverKeyRef, mergedPaginationRef, mergedFilterStateRef, mergedSortStateRef, firstContentfulColIndexRef, doUpdateFilters, doUpdateSorter, filter, filters, clearFilter, clearFilters, page, sort } = (0, use_table_data_1.useTableData)(props, { dataRelatedColsRef });
