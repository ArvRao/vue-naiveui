                            ...
                            default: () => {
                                const rawWrappedTabs = ((0, vue_1.h)("div", { style: this.tabWrapperStyle, class: `${mergedClsPrefix}-tabs-wrapper` },
                                    ...
                                    children.map((tabPaneVNode, index) => {
                                        return ((0, vue_1.h)(Tab_1.default, Object.assign({}, tabPaneVNode.props, { leftPadded: index !== 0 && !mergedJustifyContent }), tabPaneVNode.children
                                            ? {
                                                default: tabPaneVNode.children.tab
                                            }
                                            : undefined));
...
function filterMapTabPanes(tabPaneVNodes, value) {
    ...
    tabPaneVNodes.forEach((vNode) => {
        ...
        if (useVShow) {
            children.push((0, vue_1.withDirectives)(vNode, [[vue_1.vShow, show]]));
        }
        else if (show) {
            children.push(vNode);
        }
...
function createAddTag(addable, leftPadded) {
    return ((0, vue_1.h)(Tab_1.default, { ref: "addTabInstRef", key: "__addable", name: "__addable", addable: true, leftPadded: leftPadded, disabled: typeof addable === 'object' && addable.disabled }));
}
