...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        return Object.assign({ scrollableElRef,
            scrollbarInstRef, mergedClsPrefix: mergedClsPrefixRef, mergedTheme: themeRef, styleMaxWidth: styleMaxWidthRef, mergedCollapsed: mergedCollapsedRef, scrollContainerStyle: scrollContainerStyleRef, siderPlacement: siderPlacementRef, handleTriggerClick, cssVars: (0, vue_1.computed)(() => {
    ...
    render() {
        ...
        return ((0, vue_1.h)("aside", { class: [
            ...
            !this.nativeScrollbar ? ((0, vue_1.h)(scrollbar_1.NScrollbar, Object.assign({}, this.scrollbarProps, { ref: "scrollbarInstRef", style: this.scrollContainerStyle, contentStyle: this.contentStyle, theme: this.mergedTheme.peers.Scrollbar, themeOverrides: this.mergedTheme.peerOverrides.Scrollbar, 
                ...
                builtinThemeOverrides: this.inverted && this.cssVars.__invertScrollbar === 'true'
                    ...
                    : undefined }), this.$slots)) : ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-layout-sider-scroll-container`, style: [
