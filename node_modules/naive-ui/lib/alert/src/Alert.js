        ...
        return ((0, vue_1.h)(_internal_1.NFadeInExpandTransition, { onAfterLeave: this.handleAfterLeave }, {
            default: () => this.visible
                ? (0, vue_1.h)('div', (0, vue_1.mergeProps)(this.$attrs, {
                    ...
                    this.closable ? ((0, vue_1.h)(_internal_1.NBaseClose, { clsPrefix: mergedClsPrefix, class: `${mergedClsPrefix}-alert__close`, onClick: this.handleCloseClick })) : null,
                    this.showIcon ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-alert__icon` }, this.$slots.icon ? ((0, vue_1.renderSlot)(this.$slots, 'icon')) : ((0, vue_1.h)(_internal_1.NBaseIcon, { clsPrefix: mergedClsPrefix }, {
                        default: () => {
                            switch (this.type) {
                                case 'success':
                    ...
                    (0, vue_1.h)("div", { class: `${mergedClsPrefix}-alert-body` },
                        this.title !== undefined ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-alert-body__title` }, (0, vue_1.renderSlot)(this.$slots, 'header', undefined, () => [
                            this.title
                        ]))) : null,
                        this.$slots.default ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-alert-body__content` }, this.$slots)) : null)
                ])
                : null
        }));
    }
